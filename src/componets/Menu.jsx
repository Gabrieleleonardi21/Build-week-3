...
const APP_GROUPS = [
  ...
  {
    titolo: "Vendite",
    voci: [{ icona: "bi-hand-thumbs-up-fill", testo: "Marketplace dei servizi" }],
  },
  {
    titolo: "Marketing",
...
const BUSINESS = [
  ...
  { testo: "Vendi con LinkedIn", sotto: "Sblocca nuove opportunità di vendita" },
  {
  ...
  { testo: "Impara con LinkedIn", sotto: "Corsi per formare i tuoi dipendenti" },
  {
...
const MenuToggle = forwardRef(function MenuToggle({ onClick }, ref) {
  return (
    ...
    >
      <i className="bi bi-grid-3x3-gap-fill menuToggle-grid"></i>
          ...
          <div className="aziendeMenu-col">
            ...
            {BUSINESS.map((voce) => (
              <a key={voce.testo} href="#" className="aziendeMenu-business">
                <span className="aziendeMenu-business-testo">{voce.testo}</span>
                <span className="aziendeMenu-business-sotto">{voce.sotto}</span>
              </a>
            ))}
