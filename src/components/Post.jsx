    ...
    <Card className="post mb-2">
      <div className="p-3 pb-0">
        <div className="d-flex gap-2">
          <ProfileImage src={post.author.avatar} alt={post.author.name} size={48} />
          <div>
      ...
      {post.image && <img className="post-image" src={post.image} alt="Immagine del post" />}

      <div className="px-3 pt-2">
        <div className="post-counters d-flex justify-content-between">
          <span>
            <i className="bi bi-hand-thumbs-up-fill text-primary" /> {post.likes}
          </span>
          <span>
